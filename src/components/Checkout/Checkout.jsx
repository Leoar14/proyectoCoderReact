...
import { createOrdenCompra,getOrdenCompra } from '../../services/fibrebase/firestore/orders';
import { getProducts, getProductsById } from "../../services/fibrebase/firestore/products";
import { CartContext } from '../../context/CartContext';
import {updateProduct} from '../../services/fibrebase/firestore/products'
        ...
        aux.forEach(prodCarrito => {
            getProducts(prodCarrito.id).then(prod => {
                if(prod.stock >= prodCarrito.quantity) {
                    ...
                    updateProduct(prodCarrito.id, prod)
                } else {
                }
            })
        })
